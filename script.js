...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const commands = [
        { text: '> pip install backend-stack...', done: true, icons: ['python', 'leaf', 'database'] },
        { text: '> npm install frontend-tools...', done: true, icons: ['react', 'js', 'css3-alt'] },
